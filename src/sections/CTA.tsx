    ...
    return (
        <section className="py-32">
            ...
            <div className="max-w-4xl mx-auto px-6">
                ...
                <div className="relative overflow-hidden rounded-[2rem] border border-zinc-800 bg-zinc-900/50 p-12 md:p-16">
                    ...
                    <div className="relative">
                        ...
                        <a href="#contact" className="bg-blue-500 hover:bg-blue-600 px-8 py-4 rounded-2xl font-medium transition duration-300 shadow-lg shadow-blue-500/20 hover:scale-[1.02]">
                            Contactarme
                        </a>
