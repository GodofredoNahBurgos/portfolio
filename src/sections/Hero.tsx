        ...
        <section className="relative min-h-[90vh] flex items-center pt-32 pb-15 md:pb-28 lg:pb-0 overflow-hidden">
            ...
            <div className="relative max-w-6xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
                ...
                <div className="relative flex justify-center">
                    ...
                    <div className="relative w-[300px] h-[340px] md:w-[400px] md:h-[420px] lg:w-[400px] lg:h-[460px] rounded-4xl overflow-hidden border border-zinc-800 bg-zinc-900 shadow-2xl shadow-blue-500/10">
